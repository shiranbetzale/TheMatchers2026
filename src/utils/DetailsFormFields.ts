...
const detailsFormArray: FormField[] = [
  ...
  },
  {
    ...
    handlePress: () => console.log(),
    options: [
      { id: 1, name: "typeOfHeadCover", label: "כיפה שחורה", isShow: [{ fieldId: "gender", value: "1" }] },
      { id: 2, name: "typeOfHeadCover", label: "כיפה סרוגה", isShow: [{ fieldId: "gender", value: "1" }] },
      { id: 3, name: "typeOfHeadCover", label: "מטפחת", isShow: [{ fieldId: "gender", value: "2" }] },
      { id: 4, name: "typeOfHeadCover", label: "פאה", isShow: [{ fieldId: "gender", value: "2" }] },
      { id: 5, name: "typeOfHeadCover", label: "מטפחת ופאה", isShow: [{ fieldId: "gender", value: "2" }] }
    ],
    collapseTitle: "פרטים אישיים",
  },
  ...
  },
  {
    ...
    handlePress: () => console.log(),
    options: [
      { id: 1, name: "whatWorks", label: "בחור ישיבה", isShow: [{ fieldId: "gender", value: "1" }] },
      { id: 2, name: "whatWorks", label: "אברך", isShow: [{ fieldId: "gender", value: "1" }] },
      { id: 3, name: "whatWorks", label: "עובד/ת" },
      { id: 4, name: "whatWorks", label: "סטודנט/ית - לימודים אקדמיים" },
      { id: 5, name: "whatWorks", label: "חצי עובד/ת חצי לומד/ת - אקדמאי/ת" },
      { id: 6, name: "whatWorks", label: "חצי עובד חצי לומד", isShow: [{ fieldId: "gender", value: "1" }] },
      { id: 7, name: "whatWorks", label: "בצבא", isShow: [{ fieldId: "gender", value: "1" }] },
      { id: 8, name: "whatWorks", label: "שירות לאומי", isShow: [{ fieldId: "gender", value: "2" }] }
    ],
    collapseTitle: "עיסוק והשכלה",
  },
  {
  ...
  },
  {
    ...
    handlePress: () => console.log(),
    options: [
      { id: 1, name: "education", label: "תואר" },
      { id: 2, name: "education", label: "הנדסאי/ת" },
      { id: 3, name: "education", label: "בגרות" },
      { id: 4, name: "education", label: "ישיבה", isShow: [{ fieldId: "gender", value: "1" }, { fieldId: "whatWorks", value: "1" }] },
      { id: 5, name: "education", label: "12 שנות לימוד" },
    ],
    collapseTitle: "עיסוק והשכלה",
  },
